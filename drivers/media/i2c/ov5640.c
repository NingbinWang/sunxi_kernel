...
static const struct reg_value ov5640_init_setting_15fps_VGA[] = {
	...
	{0x3017, 0xff, 0, 0}, // FREX, Vsync, HREF, PCLK, D[9:6] output enable
	{0x3018, 0xff, 0, 0}, // D[5:0], GPIO[1:0] output enable
 	{0x3034, 0x1a, 0, 0},// MIPI 10-bit
	{0x3037, 0x13, 0, 0}, // PLL root divider, bit[4], PLL pre-divider, bit[3:0]
	{0x3108, 0x01, 0, 0},  //PCLK root divider, bit[5:4], SCLK2x root divider, bit[3:2]
                          // SCLK root divider, bit[1:0]
	{0x3630, 0x36, 0, 0}, {0x3631, 0x0e, 0, 0}, {0x3632, 0xe2, 0, 0}, {0x3633, 0x12, 0, 0},
	{0x3621, 0xe0, 0, 0}, {0x3704, 0xa0, 0, 0}, {0x3703, 0x5a, 0, 0},
	{0x3715, 0x78, 0, 0}, {0x3717, 0x01, 0, 0}, {0x370b, 0x60, 0, 0},
	{0x3705, 0x1a, 0, 0}, {0x3905, 0x02, 0, 0}, {0x3906, 0x10, 0, 0},
	{0x3901, 0x0a, 0, 0}, {0x3731, 0x12, 0, 0}, 
	{0x3600, 0x08, 0, 0}, {0x3601, 0x33, 0, 0}, // VCM control
	{0x302d, 0x60, 0, 0}, // system control
	{0x3620, 0x52, 0, 0},
	{0x371b, 0x20, 0, 0}, {0x471c, 0x50, 0, 0}, 
	{0x3a13, 0x43, 0, 0}, // pre-gain = 1.047x
	{0x3a18, 0x00, 0, 0}, // gain ceiling
	{0x3a19, 0xf8, 0, 0}, // gain ceiling = 15.5x
	{0x3635, 0x13, 0, 0}, {0x3636, 0x03, 0, 0}, {0x3634, 0x40, 0, 0}, {0x3622, 0x01, 0, 0},
	{0x3c01, 0x34, 0, 0}, // Band auto, bit[7]
	{0x3c04, 0x28, 0, 0}, // threshold low sum
	{0x3c05, 0x98, 0, 0}, // threshold high sum
	{0x3c06, 0x00, 0, 0}, //light meter 1 threshold[15:8]
	{0x3c07, 0x08, 0, 0}, // light meter 1 threshold[7:0]
	{0x3c08, 0x00, 0, 0}, // light meter 2 threshold[15:8]
	{0x3c09, 0x1c, 0, 0},// light meter 2 threshold[7:0]
	{0x3c0a, 0x9c, 0, 0}, // sample number[15:8]
	{0x3c0b, 0x40, 0, 0},// sample number[7:0]
	{0x3810, 0x00, 0, 0},// Timing Hoffset[11:8]
	{0x3811, 0x10, 0, 0},// Timing Hoffset[7:0]
	{0x3812, 0x00, 0, 0},// Timing Voffset[10:8]
	{0x3708, 0x64, 0, 0},
	{0x4001, 0x02, 0, 0},  // BLC start from line 2
	{0x4005, 0x1a, 0, 0}, // BLC always update
	{0x3000, 0x00, 0, 0}, // enable blocks
	{0x3004, 0xff, 0, 0},// enable clocks
	{0x300e, 0x58, 0, 0},  // MIPI power down, DVP enable
	{0x302e, 0x00, 0, 0},
	{0x4300, 0x30, 0, 0}, // YUV 422, YUYV
	{0x501f, 0x00, 0, 0}, // YUV 422
	{0x440e, 0x00, 0, 0},
...
static const struct reg_value ov5640_setting_720P_1280_720[] = {
	{0x3035, 0x41, 0, 0}, {0x3036, 0x69, 0, 0}, //PLL
	{0x3c07, 0x07, 0, 0}, // lightmeter 1 threshold[7:0]
	{0x3820, 0x41, 0, 0}, // flip
	{0x3821, 0x07, 0, 0}, // mirror
	{0x3814, 0x31, 0, 0}, //timing X inc
	{0x3815, 0x31, 0, 0}, //timing Y inc
	{0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},//HS
	{0x3802, 0x00, 0, 0}, {0x3803, 0xfa, 0, 0},//VS
	{0x3804, 0x0a, 0, 0}, {0x3805, 0x3f, 0, 0}, //HW(HE)
	{0x3806, 0x06, 0, 0}, {0x3807, 0xa9, 0, 0},//VH(VE)
	{0x3808, 0x05, 0, 0}, {0x3809, 0x00, 0, 0},//DVPHO
	{0x380a, 0x02, 0, 0}, {0x380b, 0xd0, 0, 0},//DVPVO
	{0x380c, 0x07, 0, 0}, {0x380d, 0x64, 0, 0},//HTS
	{0x380e, 0x02, 0, 0}, {0x380f, 0xe4, 0, 0},//VTS
    {0x3813, 0x04, 0, 0},
	{0x3618, 0x00, 0, 0}, {0x3612, 0x29, 0, 0},
	{0x3709, 0x52, 0, 0}, {0x370c, 0x03, 0, 0},
	{0x3a02, 0x02, 0, 0}, {0x3a03, 0xe0, 0, 0}, //60Hz max exposure
	//{0x3a08, 0x00, 0, 0}, {0x3a09, 0x6f, 0, 0}, {0x3a0a, 0x00, 0, 0}, {0x3a0b, 0x5c, 0, 0}, //B50 B60 STEP
	//{0x3a0e, 0x06, 0, 0},
	//{0x3a0d, 0x08, 0, 0},
	{0x3a14, 0x02, 0, 0}, {0x3a15, 0xe0, 0, 0},// 50Hz max exposure
    {0x4004, 0x02, 0, 0}, //BLC line number
    {0x3002, 0x1C, 0, 0}, //reset JFIFO, SFIFO, JPG
    {0x3006, 0xc3, 0, 0}, //disable clock of JPEG2x, JPEG
	{0x4713, 0x03, 0, 0}, //JPEG mode 3
    {0x4407, 0x04, 0, 0}, //Quantization scale
    {0x460b, 0x37, 0, 0}, {0x460c, 0x20, 0, 0},
	{0x4837, 0x16, 0, 0}, //MIPI global timing
	{0x3824, 0x04, 0, 0}, // PCLK manual divider
    {0x5001, 0x83, 0, 0}, // SDE on, CMX on, AWB on
    {0x3503, 0x00, 0, 0}, //AEC/AGC on
